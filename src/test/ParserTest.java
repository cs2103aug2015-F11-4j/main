...
public class ParserTest {
	...
	public void filterByEndDate() {
		...
		int month = cal.get(Calendar.MONTH)+1;
		int day = cal.get(Calendar.DAY_OF_MONTH);
		String endDate = String.valueOf(year) + "/" + String.valueOf(month) +
				"/" + String.valueOf(day);
	...
	public void update1() {
		...
		String endDate = String.valueOf(year2) + "/" + String.valueOf(month2) +
				"/" + String.valueOf(day2);
		assertEquals("end date: ", "2015/12/30", endDate);
		...
		String reminderDate = String.valueOf(year3) + "/" + String.valueOf(month3) +
				"/" + String.valueOf(day3);
	...
	public void add2() {
		...
		int month2 = cal2.get(Calendar.MONTH)+1;
		int day2 = cal2.get(Calendar.DAY_OF_MONTH);
		String reminderDate = String.valueOf(year2) + "/" + String.valueOf(month2) +
				"/" + String.valueOf(day2);
		assertEquals("reminder date: ", "2015/12/30", reminderDate);
