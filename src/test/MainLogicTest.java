...
import stub.EventHandlerUndoAddStub;
import stub.EventHandlerUndoDeleteStub;
import stub.EventHandlerUndoUpdateStub;
...
public class MainLogicTest {
	...
	public void executeUndelete() {
		MainLogic mainLogic = new MainLogic();
		mainLogic.injectEventHandler(new EventHandlerUndoDeleteStub());
		mainLogic.injectParser(new ParserStub());
	...
	public void executeUndoAdd() {
		MainLogic mainLogic = new MainLogic();
		mainLogic.injectEventHandler(new EventHandlerUndoAddStub());
		mainLogic.injectParser(new ParserStub());
	...
	public void executeUndoUpdate() {
		MainLogic mainLogic = new MainLogic();
		mainLogic.injectEventHandler(new EventHandlerUndoUpdateStub());
		mainLogic.injectParser(new ParserStub());
