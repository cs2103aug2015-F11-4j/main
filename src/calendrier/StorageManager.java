...
public class StorageManager {
	...
	public void remove(Event event) {
		...
		updateStatus();
		year.get(index).getMonth(event.getStartDateTime().getTime().getMonth())
				.getDate(event.getStartDateTime().getTime().getDate()).deleteTask(event);
	}
	...
	// This is use to check for the content stored in List. Will remove after
	// coding is done.
	...
	/**
	 * This method is to convert the string file to event as well as adding it
	 * to the List.
	 */
